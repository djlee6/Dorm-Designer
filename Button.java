...
public class Button implements DormGUI {
    ...
    private static final int WIDTH = 96;//instance fields of the buttons
    ...
    public Button(String label, float x, float y, PApplet processing) { //constructor which draws the button box
    ...
    public void update() { //method updates the buttons
